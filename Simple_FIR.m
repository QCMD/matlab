classdef Simple_FIR < handle
    ...
    methods(Access=private) %initialize
        ...
        function createComponents(app)
            % create UI figure
        app.UIFigure=figure;
        app.UIFigure.Color=[0.7 0.9 0.7];
...
% panel
        ...
        app.P1.Position=[0.03 .03 .38 .90];
        app.P1.BackgroundColor=[0 0 0];
     
          %create P2
        app.P2=uipanel(app.UIFigure);
        app.P2.Position=[0.55 .05 .38 .90];
        app.P2.BackgroundColor=[0.6 0.6 0.6];
%axis
        ...
        app.Ax1.Visible='off';
        %Axis in P1-1
        app.AxP1_1=axes(app.P1,'Position',[0 .50 1 .50]);
        app.AxP1_1.Visible='off';
        app.AxP1_1.Color=[.7 .7 .7];
        
        
        %Axis in P1-2
        app.AxP1_2=axes(app.P1,'Position',[0 0 1.02 .52]);
        app.AxP1_2.Visible='off';
        app.AxP1_2.Color=[.7 .7 .7];
%buttons
   ...
   %freq
        ...
        app.TextFreqlower=uicontrol(app.UIFigure,'Style','edit','units','normalized'...
             ,'String','1','Position',[.42 .40 .04 .04],'BackgroundColor',[.3 .5 .7]);
        ...
        app.TextFrequpper=uicontrol(app.UIFigure,'Style','edit','units','normalized'...
             ,'String','100','Position',[.50 .40 .04 .04],'BackgroundColor',[.3 .5 .7]);
        ...
        app.TextFreq=uicontrol(app.UIFigure,'Style','text','units','normalized'...
             ...
             'BackgroundColor',[0.7 .9 .7]);
          % selectFilter
        app.selectFilter=uicontrol(app.UIFigure,'Style','popupmenu','units','normalized'...
             ,'String',{'bandpass','low','high','stop'},'Position',[.45 .45 .06 .018],'BackgroundColor',[.3 .5 .7]);
   ...
   % sample     
        ...
        app.Text1=uicontrol(app.UIFigure,'Style','edit','units','normalized'...
             ,'String','1','Position',[.42 .62 .04 .04],'BackgroundColor',[.3 .5 .6]);
        ...
        app.Text2=uicontrol(app.UIFigure,'Style','edit','units','normalized'...
             ,'String','10','Position',[.50 .62 .04 .04],'BackgroundColor',[0.3 .5 .6]);
        ...
        app.Title=uicontrol(app.P2,'Style','text','units','normalized'...
             ...
             14,'Position',[.12 .90 .76 .07],'HorizontalAlignment','center','BackgroundColor',[0.7 .8 .4]);
         % Text5  static
        ...
        app.Text4=uicontrol(app.P2,'Style','text','units','normalized',...
                ...
                10,'HorizontalAlignment','left','Position',[.03 .74 .40 .13],'BackgroundColor',[.7 .3 .3]);
   ...
   %funtional button
        ...
        app.ImportButton=uicontrol(app.UIFigure,'Style','pushbutton',...
          ...
          'Position',[.44 .7 .07 .05],'BackgroundColor',[0.3 0.8 0.6]);
        ...
        app.ConfirmButton=uicontrol(app.UIFigure,'Style','pushbutton',...
          ...
          'Position',[.43 .58 .1 .03],'BackgroundColor',[0.3 0.8 0.6]);
        ...
        app.ConvertButton=uicontrol(app.UIFigure,'Style','pushbutton',...
          ...
          'Position',[.44 .51 .07 .05],'BackgroundColor',[.3 .8 .6]);
        ...
        app.clearButton=uicontrol(app.UIFigure,'Style','pushbutton',...
          ...
          'Position',[.02 .93 .07 .05],'BackgroundColor',[.3 .8 .6]);
